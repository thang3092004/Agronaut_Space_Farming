...
st.title("Part 1 — Slide 03.4: P_RADIUS_EST")
...
text_html = (
  '🌍 <b>P_RADIUS_EST — Size (R⊕)</b><br/>Relative to Earth.<br/><br/>'
  'Small to medium → rocky planet<br/>Too large → gas world ☁️'
)
...
col = st.columns([1,1])
with col[0]:
  back = st.button("⬅️ Back", key="_back_s3_4")
with col[1]:
  nxt = st.button("Continue ➡️", key="_next_s3_4")

if back:
    st.switch_page("pages/1_🔭_Phần_1_Slide_03_3.py")
if nxt:
  st.switch_page("pages/1_🔭_Phần_1_Slide_03_5.py")
