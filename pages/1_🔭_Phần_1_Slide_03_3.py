...
st.title("Part 1 — Slide 03.3: P_TEMP_EQUIL")
...
text_html = (
  '🌡️ <b>P_TEMP_EQUIL — Temperature (K)</b><br/>Estimated equilibrium temperature (no clouds).<br/><br/>'
  'Moderate warmth → liquid water can exist 💧'
)
...
col = st.columns([1,1])
with col[0]:
  back = st.button("⬅️ Back", key="_back_s3_3")
with col[1]:
  nxt = st.button("Continue ➡️", key="_next_s3_3")

if back:
    st.switch_page("pages/1_🔭_Phần_1_Slide_03_2.py")
if nxt:
  st.switch_page("pages/1_🔭_Phần_1_Slide_03_4.py")
