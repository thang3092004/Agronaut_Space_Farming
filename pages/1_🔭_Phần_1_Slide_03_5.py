...
st.title("Part 1 — Slide 03.5: P_PERIOD")
...
text_html = (
  '🪐 <b>P_PERIOD — Orbital Period (days)</b><br/>Time to orbit its star once.<br/><br/>'
  'Closer to star → hotter ☀️<br/>Farther away → colder ❄️'
)
...
col = st.columns([1,1])
with col[0]:
  back = st.button("⬅️ Back", key="_back_s3_5")
with col[1]:
  nxt = st.button("Continue ➡️", key="_next_s3_5")
